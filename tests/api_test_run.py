...
from structured_search.api.app import post_run, post_run_validate
...
def test_run_runtime_error_returns_500(monkeypatch):
    ...
    def _boom(_request: RunScoreRequest):
...
def test_run_validate_response_includes_snapshot_probe(monkeypatch):
    ...
    def _fake_validate(_request: RunScoreRequest) -> RunValidateSummary:
...
def test_run_validate_missing_profile_returns_404(monkeypatch):
    ...
    def _missing(_request: RunScoreRequest):
